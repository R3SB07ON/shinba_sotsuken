//難易度（0<4）(-1は広告メール（良いメールでも悪いメールでもない）)、件名
const mailList = [
	[0,"セキュリティ講座の見積書について"],
	[0,"貴社訪問のお願い"],
	[2,"お振込受付のお知らせ"],
...
let mail_text = new Array(	"お世話になっております。\
                            ...
                            ************************************ <br>\
                            ...
                            <input type='button' class= music value='招待リンクを贈る' onclick='alert(\"内容をチェックした。\");Z_spam_mail_click();'>",
                            ...
                            <input type='button' class= rakuten value='配達状況のご案内はこちら' onclick='alert(\"内容をチェックした。\");Z_spam_mail_click();'>",
